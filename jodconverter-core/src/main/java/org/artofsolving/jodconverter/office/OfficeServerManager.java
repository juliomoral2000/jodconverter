...
/**
 * {@link org.artofsolving.jodconverter.office.OfficeManager} implementation that connects to an external Office process.
 * <p>
 ...
 * <p>
 * This {@link org.artofsolving.jodconverter.office.OfficeManager} implementation basically provides the same behaviour as JODConverter 2.x, including using <em>synchronized</em> blocks for serialising office
 * operations.
 */
public class OfficeServerManager implements OfficeManager {
	 ...
	 *            {@link org.artofsolving.jodconverter.office.OfficeTask} is executed.
	 */
    public OfficeServerManager(UnoUrl unoUrl, boolean connectOnStart) {
